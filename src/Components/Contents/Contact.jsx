          ...
          <Col md={6} lg={6} sm={12} xs={12} data-aos="fade-left">
            ...
            <div className="contact__me2">
              ...
              <div className="contact__info">
                ...
                <br />
                <p>
                  Sunday: 12:00-17:00 (This primarily applies to the shops on
                  and near the Nieuwendijk and Kalverstraat. In some of the
                  other shopping streets, you may find that only a selection of
